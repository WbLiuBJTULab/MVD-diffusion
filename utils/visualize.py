...
def visualize_pointcloud_hq(points, normals=None,
                         out_file=None, show=False, elev=30, azim=225,
                         point_size=2, point_color='b', title=None, axis_labels=('X', 'Y', 'Z')):
    '''
    ...
    Args:
        ...
        out_file (string): output file
        show (bool): whether the plot should be shown
        elev (int): elevation angle in the z plane
        azim (int): azimuth angle in the x,y plane
        point_size (int): size of the points
        point_color (str or array-like): color of the points
    ...
    # Plot points
    ax.scatter(points[:, 0], points[:, 1], points[:, 2], c=point_color, s=point_size)

    # Plot normals if provided
    if normals is not None:
        ax.quiver(
