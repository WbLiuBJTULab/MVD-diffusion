...
__C.DATASETS.SHAPENET.PARTIAL_POINTS_PATH        = '/opt/Dataset/PCN_lmdb/shapenet/%s/partial/%s/%s/%02d.pcd'
__C.DATASETS.SHAPENET.COMPLETE_POINTS_PATH       = '/opt/Dataset/PCN_lmdb/shapenet/%s/complete/%s/%s.pcd'
...
__C.CONST.DEVICE                                 = '0'
__C.CONST.WEIGHTS                                = './exp/output/checkpoints/2024-06-16T01:47:40.252551/ckpt-best.pth'  # './pretrained/pcn/ckpt-best-pmpplus.pth specify' a path to run test and inference
