...
from model.pvcnn_completion_20240206_2041_1 import PVCNN2Base
...
class GaussianDiffusion:
    def __init__(self, betas, loss_type, model_mean_type, model_var_type, sv_points, num_views):
        #_修改位置
    ...
    def p_sample_loop(self, partial_x, denoise_fn, shape, device,
        ...
        # print(partial_x.shape) [80, 3, 200]
        img_t = torch.cat([partial_x] * self.num_views, dim=-1)
        # print(img_t.shape) [80, 3, 200]
        img_t = torch.cat([img_t , noise_fn(size=shape, dtype=torch.float, device=device)], dim=-1)
        # print(img_t.shape)# [80, 3, 2048]
    ...
    def _vb_terms_bpd(self, denoise_fn, data_start, data_t, t, clip_denoised: bool, return_pred_xstart: bool):
        ...
        data_t_in = torch.cat([data_t_in , data_t[:, :, self.sv_points:]], dim=-1)
...
class PVCNN2(PVCNN2Base): #现在在做推断任务
    sa_blocks = [
...
class Modeltrainer(nn.Module):
    def __init__(self, args, betas, loss_type: str, model_mean_type: str, model_var_type:str):
        ...
        self.diffusion = GaussianDiffusion(betas, loss_type, model_mean_type, model_var_type, args.svpoints, args.num_views)
    ...
    def _denoise(self, data, t, sv_points, num_views):
        ...
        out = self.model(data, t, sv_points, num_views)
        # _调试代码
        '''
        print('out___')
        print(out)
