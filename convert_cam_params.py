...
if __name__ == '__main__':
    ...
    args.add_argument('--dataroot', type=str, default='/opt/data/private/zzx/workspace/common/shapenet_cars_chairs_planes_20views')
    args.add_argument('--mitsuba_xml_root', type=str, default='/opt/data/private/zzx/workspace/common/shapenet_cars_chairs_planes_20views/genre-xml_v2')
